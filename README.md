...
| 🔭 ASTRO → Osservatorio | Cielo di adesso (6 carte + grado), Horizons NASA, Satelliti live (ISS, Starlink, Terra/meteo con foto GIBS/GOES) | Hipparcos + Astronomy Engine + [JPL Horizons](https://ssd.jpl.nasa.gov/horizons/) + WTIA + TLE/SGP4 + NASA GIBS + NOAA |
...
services/sats.py       # TLE live + SGP4 (Tiangong, Hubble, Terra, meteo, Starlink)
services/satimages.py  # foto GIBS / GOES dei satelliti Terra e meteo
