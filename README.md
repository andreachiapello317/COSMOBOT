...
`/start` apre **BOTSQUAD**: un portale. **🔮 ORACOLO**, **🔭 ASTRO**, **🌍 TERRA**, **📡 OGGI**, **🧰 STRUMENTI** e **🧩 QUIZ**. Il quiz è un bot a parte: scegli il mondo, poi l'argomento. Ogni scheda ha una riga di presentazione. I mondi non si mescolano.
...
| 🧩 QUIZ | Una prova per ogni bot: oracolo, astro, terra, oggi, strumenti | cataloghi locali; ASTRO ha anche Wikipedia live |
