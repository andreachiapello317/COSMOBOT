...
| 🎲 GIOCHI → Tavolo | Dadi, moneta, morra, indovina, alto o basso: un passo alla volta (scegli → pronto → lancia) | caso locale; non è un oracolo e non si vince soldi |
...
| 🌍 TERRA → Città | OpenStreetMap intorno al luogo: vicino, mobilità, sicurezza, vita, servizi, passeggiata. Default **Cuneo**, niente GPS | [Overpass](https://wiki.openstreetmap.org/wiki/Overpass_API) + [Open-Meteo air](https://open-meteo.com) + [Meteoalarm](https://feeds.meteoalarm.org) |
...
services/games.py      # dadi, moneta, morra, indovina: workflow guidato (bot GIOCHI)
...
services/citylife.py   # Città: Overpass OSM intorno al luogo (niente GPS)
