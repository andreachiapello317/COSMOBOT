...
def tool_hub_text() -> str:
    return _card(
        ...
        "📅 <b>CALENDARIO</b> — ora e mese, eventi (Pasqua, Natale…), compleanni",
    )


def calendar_hub_text() -> str:
    return _card(
        "📅 <b>CALENDARIO</b>",
...
def world_fauna_text() -> str:
    return _card(
        "🐾 <b>FAUNA</b>",
        "Osservati = qualcuno li ha visti e li ha pubblicati. Non è un collare GPS.",
        "🐾 Osservati recenti — iNaturalist, GBIF, eBird intorno al luogo (anche i parchi vicini)\n"
...
def world_natura_text() -> str:
    return _card(
        ...
        "Apro la voce, non la riscrivo. Gli animali osservati stanno nella porta Animali.",
    )
